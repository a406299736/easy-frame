...
import (
	...
	"github.com/easy-frame/repository"
...
func (t *{{.StructName}}) Create(db *gorm.DB) (id int32, er error) {
...
func (qb *{{.QueryBuilderName}}) Updates(db *gorm.DB, m map[string]interface{}) (er error) {
...
func (qb *{{.QueryBuilderName}}) Delete(db *gorm.DB) (er error) {
	for _, where := range qb.where {
...
{{range .OptionFields}}
func (qb *{{$queryBuilderName}}) Where{{call $.Helpers.Titelize .FieldName}}(p repository.Predicate, value {{.FieldType}}) *{{$queryBuilderName}} {
